        ...
        try {
            ...
            if (result.success) {
                ...
                await addDoc(collection(db, "posts"), {
                    ...
                    userPhoto: user.photoURL || "", // Profil şəklini bura əlavə etdik
                    userId: user.uid,
                    likes: 0,
                    comments: [],
...
// Postları Firestore-dan real zamanlı yükləyir
function loadPosts() {
...
// Hər bir postun HTML strukturunu yaradır
function renderPostHTML(id, data, isLiked, author) {
    // Əgər bazada şəkil varsa onu istifadə et, yoxdursa hərfli avatar yarat
...
// Takipləşmə Funksiyası
window.handleFollow = (targetId) => {
    alert("İstifadəçi izlənilir!");
};

// Düymə hadisələrini bağlayırıq
